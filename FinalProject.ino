...
#define DEBUG true
#define SSID "_Hirasawa_"     // "SSID-WiFiname"
#define PASS "hirasawa" // "password"
...
String msg = "GET /update?key=GOVZX2R4UX4B9988"; 
...
void setup()
{
  ...
  // Double-check the "pulseSensor" object was created and "began" seeing a signal. 
   if (pulseSensor.begin()) {
    Serial.println("Patient Health Monitoring system Initialized!");  //This prints one time at Arduino power-up,  or on Arduino reset.  
  }
  Serial.println("AT");
  esp8266.println("AT");
...
void getReadings(){
  ...
  tempC = Voltage * 0.1; 
  myTemp = (tempC * 1.8) + 32; // convert to F
